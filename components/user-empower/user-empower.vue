<template>
	<view v-if="isEmpower == true" class="page-login">
		<view  class="conbox flex flex-d al-center">
			<view class="conTil">
				温馨提示
			</view>
			...
			<view class="flex ju-center m-t3">
				<view @click="isEmpower = false" class="btn flex al-center ju-center">
					再想想
				</view>
				<view @click="bindGetUserInfo" class="gobtn flex al-center ju-center">
					去授权
				</view>
			</view>
		</view>
