...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.historicalVisitors = exports.operation = exports.wxvisitDetail = exports.wxvisitTobe = exports.addThird = exports.getUserInfos = exports.addWxvisit = exports.getUser = exports.setUser = exports.pushUser = exports.getWxVisit = exports.getinfo = exports.getUserInfo = exports.getOpen = exports.login = void 0;var _http = _interopRequireDefault(__webpack_require__(/*! @/utils/http */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
// 新增用户信息
exports.getWxVisit = getWxVisit;var pushUser = function pushUser(user) {
  return _http.default.post("/api/wx/wxuser", user);
};
// 修改用户信息
exports.pushUser = pushUser;var setUser = function setUser(id, user) {
  return _http.default.put("/api/wx/wxuser/".concat(id), user);
};
// 获取用户信息
exports.setUser = setUser;var getUser = function getUser(id) {
  return _http.default.get("/api/wx/wxuser/".concat(id));
};
// 新增访客记录
...
//我的拜访历史
exports.operation = operation;var historicalVisitors = function historicalVisitors(id) {
  return _http.default.get("/api/wx/wxvisit/history/".concat(id));
};
// .}
exports.historicalVisitors = historicalVisitors;
...
/***/ 218:
/*!****************************************************************************************!*\
  !*** C:/Users/webcode001/Desktop/ly/cloud-eazy-visit-mini/static/img/tabbar/home1.png ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 219:
/*!****************************************************************************************!*\
  !*** C:/Users/webcode001/Desktop/ly/cloud-eazy-visit-mini/static/img/tabbar/home2.png ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"
...
/***/ 220:
/*!****************************************************************************************!*\
  !*** C:/Users/webcode001/Desktop/ly/cloud-eazy-visit-mini/static/img/tabbar/syis1.png ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 221:
/*!****************************************************************************************!*\
  !*** C:/Users/webcode001/Desktop/ly/cloud-eazy-visit-mini/static/img/tabbar/syis2.png ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 222:
/*!**************************************************************************************!*\
  !*** C:/Users/webcode001/Desktop/ly/cloud-eazy-visit-mini/static/img/tabbar/my1.png ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 223:
/*!**************************************************************************************!*\
  !*** C:/Users/webcode001/Desktop/ly/cloud-eazy-visit-mini/static/img/tabbar/my2.png ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getWxAuthUrl = getWxAuthUrl;exports.Reason_TYPES = exports.IDCAR_TYPE = exports.INTERVIEWEE_STATUS = exports.TEST_WEBSOCKET_HOST = exports.API_BASE_URL = exports.HOST = exports.APPID = void 0; // 小程序appId
...
var HOST = 'cev.liephipps.com'; // 开发测试公网
exports.HOST = HOST;var API_BASE_URL = "https://".concat(HOST);
...
var IDCAR_TYPE = { 1: ' 身份证', 2: '护照', 3: '驾驶证' };exports.IDCAR_TYPE = IDCAR_TYPE;

var Reason_TYPES = [{ titel: '面试', id: 1 }, { titel: '商务拜访', id: 2 }, { titel: '政务拜访', id: 3 }, { titel: '探亲', id: 4 }, { titel: '参观', id: 5 }];exports.Reason_TYPES = Reason_TYPES;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = request; // const baseUrl = 'http://192.168.0.105:8765';
var baseUrl = 'http://cev.liephipps.com';
